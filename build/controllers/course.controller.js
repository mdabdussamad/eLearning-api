...
exports.generateYouTubeUrl = exports.deleteCourse = exports.getAdminAllCourses = exports.addRelyReview = exports.addReview = exports.addAnswer = exports.addQuestion = exports.getCourseByUser = exports.getAllCourses = exports.getSingleCourse = exports.editCourse = exports.uploadCourse = void 0;
...
exports.addAnswer = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        // Ensure questionReplies is initialized as an array
...
exports.addRelyReview = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
...
//   }
// );
exports.generateYouTubeUrl = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const { videoId } = req.body;
        if (!videoId) {
