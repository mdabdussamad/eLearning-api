...
exports.registrationUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        let html;
        try {
            html = await ejs_1.default.renderFile(path_1.default.join(__dirname, "../mails/activation-mail.ejs"), data);
        }
        catch (error) {
            return next(new ErrorHandler_1.default("Error rendering email template", 500));
        }
        ...
        return next(new ErrorHandler_1.default("Server Error", 500));
    }
});
...
exports.updateUserRole = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (isUserExist) {
            ...
            (0, user_service_1.updateUserRolService)(res, id, role);
        }
        else {
            res.status(400).json({
                success: false,
